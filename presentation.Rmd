...
print(xtable(prettyNum(highestTotalWages,
                       big.mark=",",
                       preserve.width="none"),
             digits=0, 
             caption = "Top three total wage paying departments, excludes departments with less than 30 employeees",  
             label="tblFinalReg", 
...
print(xtable(prettyNum(highestWagesOT,
                       big.mark=",",
                       preserve.width="none"),
             digits=0, 
             caption = "Top three overtime paying departments, excludes departments with less than 30 employeees",  
             label="tblFinalReg", 
             align = "rl{4cm}r{3cm}r{3cm}"
             ), 
      caption.placement = "bottom", 
